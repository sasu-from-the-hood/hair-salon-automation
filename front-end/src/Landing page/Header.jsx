      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto flex justify-between items-center p-2 md:p-4">
          ...
          <div className="hidden md:flex flex-col md:flex-row md:space-x-4">
            <Link to="/login" className="px-2 py-1 md:px-4 md:py-2 bg-black text-white rounded hover:bg-gray-500">Login</Link>
            <Link to="/signup" className="px-2 py-1 md:px-4 md:py-2 bg-black text-white rounded hover:bg-gray-500">Sign Up</Link>
          </div>
        </div>
