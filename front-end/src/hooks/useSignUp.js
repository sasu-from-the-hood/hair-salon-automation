...
const useSignUp = () => {
    ...
    return {
        email,
        setEmail: (value) => { setEmail(value); validateInput('email', value); },
        name,
        setName: (value) => { setName(value); validateInput('name', value); },
        password,
        setPassword: (value) => { setPassword(value); validateInput('password', value); },
        confirmPassword,
        setConfirmPassword: (value) => { setConfirmPassword(value); validateInput('confirmPassword', value); },
        phone_number,
        setphone_number: (value) => { setphone_number(value); validateInput('phone_number', value); },
        loading,
        inputErrors,
        handleSubmit,
    };
