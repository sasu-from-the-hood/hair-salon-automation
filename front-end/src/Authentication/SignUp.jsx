              ...
              <div className="w-full flex-1 mt-8">
                <div className="flex flex-col items-center">
                  ...
                  >
                    <div className="bg-white p-2 rounded-full">
                      <img src="https://img.icons8.com/color/48/000000/google-logo.png" alt="" className="w-6" />
                    </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {!showOtherInputs && (
                    <div className="mt-4 text-xs text-gray-600 text-center">
                      <p>I agree to abide by terms of service and privacy policy.</p>
                      Already have an account?
                      <Link to="/sign-in" className="border-b  ml-1 text-indigo-500 border-gray-500 border-dotted">
                        Sign in
                      </Link>
                    </div>
                  )}

                  <div className={`transition-all duration-500 ease-in-out transform ${showOtherInputs ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4 pointer-events-none'}`}>
                    <div className="mx-auto max-w-xs mt-3">
                      <div className="flex items-center border border-gray-200 rounded-lg bg-gray-100 focus-within:border-gray-400">
                        ...
                        <input
                          type="text"
                          placeholder="Name"
                          className={`w-full px-4 py-3 rounded-lg font-medium placeholder-gray-500 text-sm focus:outline-none ${inputErrors.name ? 'border-red-500' : 'border-transparent'}`}
                          value={name}
                    ...
                    <div className="mx-auto max-w-xs mt-3">
                      <div className="flex items-center border border-gray-200 rounded-lg bg-gray-100 focus-within:border-gray-400">
                        <FontAwesomeIcon icon={faPhone} className="p-2 text-gray-500" />
                        <input
                          type="tel"
                          placeholder="Phone Number"
                          className={`w-full px-4 py-3 rounded-lg font-medium placeholder-gray-500 text-sm focus:outline-none ${inputErrors.phone_number ? 'border-red-500' : 'border-transparent'}`}
                          value={phone_number}
                    ...
                    <div className="mx-auto max-w-xs mt-3">
                      <div className="flex items-center border border-gray-200 rounded-lg bg-gray-100 focus-within:border-gray-400">
                        ...
                        <input
                          ...
                          className={`w-full px-4 py-3 rounded-lg font-medium placeholder-gray-500 text-sm focus:outline-none ${inputErrors.confirmPassword ? 'border-red-500' : 'border-transparent'}`}
                ...
                {showOtherInputs && (
                  <div className="mt-6 text-xs text-gray-600 text-center">
                    <p>I agree to abide by terms of service and privacy policy.</p>
                    Already have an account?
                    <Link to="/sign-in" className="border-b text-indigo-500 border-gray-500 border-dotted">
                      Sign in
                    </Link>
                  </div>
                )}
