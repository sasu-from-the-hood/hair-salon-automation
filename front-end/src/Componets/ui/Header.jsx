      ...
      <header className="bg-white shadow-md">
        <div className="container mx-auto flex justify-between items-center p-2 md:p-4">
          <div className="flex items-center space-x-1 md:space-x-2">
            ...
            <p
              className="text-sm md:text-base text-orange-500 font-bold"
              style={{ fontFamily: '"Dancing Script", cursive' }}
            >
              BEAUTYSALON
            </p>
          ...
          <nav className="hidden md:flex flex-col md:flex-row md:space-x-20">
            <Link
              to="/"
              className="text-sm md:text-base text-orange-500 hover:text-gray-500 font-bold"
            >
              Home
            </Link>
            <Link
              to="/service"
              className="text-sm md:text-base text-black hover:text-gray-500 font-bold"
            >
              Service
            </Link>
            <Link
        ...
        <div className="md:hidden">
          <nav
            className="flex flex-col space-y-2 p-2 bg-white shadow-md hidden absolute right-0"
            id="dropdown-menu"
          >
            <Link
              to="/"
            ...
            <Link
              to="/login"
              className="px-2 py-1 bg-black text-white rounded hover:bg-gray-500"
            >
              Login
            </Link>
            <Link
